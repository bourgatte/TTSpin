...
parser.add_argument("-c", "--config-parameters",help="Configuration file:  pythia_H.conf or pythia_Z.conf   [Default: %(default)s] ",  type=str, action="store", default = 'pythia_Z.conf')
...
cmd = './transspin_pythia_tauola.exe ' + args.config_parameters     + ' ' + args.collision_type + ' ' +  args.events_number     + ' ' +  args.mixing_angle + ' ' + args.output_file
print cmd
os.system(cmd) 
