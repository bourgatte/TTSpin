...
//
// 
/**\class TauTauSpiner.h TauTauSpiner.cc
 Description: 
*/
//
...
#ifndef TauTauSpiner_h
#define TauTauSpiner_h
#include <vector>
...
class TauTauSpiner {
 public:
  TauTauSpiner();
  TauTauSpiner(vector<TLorentzVector> TauAndProd, string type, int TauCharge=1);
  TauTauSpiner(vector<TLorentzVector> TauAndProd1, string type1,  vector<TLorentzVector> TauAndProd2, string type2,int TauCharge1=1, int TauCharge2=1);
  ~TauTauSpiner();
